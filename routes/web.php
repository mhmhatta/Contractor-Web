...
// ====================>> Laporan <<======================= //
// Laporan Harian
Route::get('/stafflapangan/Laporan-Harian/{idproject}', [ProjectControllerStafflapangan::class, 'laporanHarian'])->middleware('jabatan:Pengawas_Lapangan');
Route::get('/stafflapangan/buatlaporanharian/{idproject}',[LaporanHarianStaffLapanganController::class, 'index'])->middleware('jabatan:Pengawas_Lapangan')->name('buatlaporan');
Route::get('/stafflapangan/detail-laporan/{idharian}',[LaporanHarianStaffLapanganController::class, 'show'])->middleware('jabatan:Pengawas_Lapangan')->name('viewlaporan');
Route::get('/hapuspk/{kode_laporan_harian}/{tugas_jabatan}',[LaporanHarianStaffLapanganController::class, 'hapuspk'])->middleware('jabatan:Pengawas_Lapangan');
Route::get('/hapuspkr/{kode_laporan_harian}/{jenis_pekerjaan}',[LaporanHarianStaffLapanganController::class, 'hapuspkr'])->middleware('jabatan:Pengawas_Lapangan');
Route::get('/hapuspr/{kode_laporan_harian}/{jenis}',[LaporanHarianStaffLapanganController::class, 'hapuspr'])->middleware('jabatan:Pengawas_Lapangan');
Route::get('/hapustmpb/{kode_laporan_harian}/{jenis}',[LaporanHarianStaffLapanganController::class, 'hapustmpb'])->middleware('jabatan:Pengawas_Lapangan');
Route::get('/hapuscba/{kode_laporan_harian}/{jenis}',[LaporanHarianStaffLapanganController::class, 'hapuscba'])->middleware('jabatan:Pengawas_Lapangan');
Route::get('/hapuskjpp/{kode_laporan_harian}/{jenis}',[LaporanHarianStaffLapanganController::class, 'hapuskjpp'])->middleware('jabatan:Pengawas_Lapangan');
Route::post('/submitcba',[SubmitLaporanController::class, 'cba'])->middleware('jabatan:Pengawas_Lapangan');
Route::post('/submitpk',[SubmitLaporanController::class, 'pk'])->middleware('jabatan:Pengawas_Lapangan');
Route::post('/submitpkr',[SubmitLaporanController::class, 'pkr'])->middleware('jabatan:Pengawas_Lapangan');
Route::post('/submitpr',[SubmitLaporanController::class, 'pr'])->middleware('jabatan:Pengawas_Lapangan');
Route::post('/submittmpb',[SubmitLaporanController::class, 'tmpb'])->middleware('jabatan:Pengawas_Lapangan');
Route::post('/submitkjpp',[SubmitLaporanController::class, 'kjpp'])->middleware('jabatan:Pengawas_Lapangan');
Route::get('/stafflapangan/kirimlaporan/{idlaporan}',[SubmitLaporanController::class, 'kirim'])->middleware('jabatan:Pengawas_Lapangan');
Route::get('/stafflapangan/hapus/{idlaporan}',[SubmitLaporanController::class, 'hapus'])->middleware('jabatan:Pengawas_Lapangan');

// Laporan Progress
Route::get('/stafflapangan/Laporan-Progress/{idproject}', [ProjectControllerStafflapangan::class, 'laporanProgress'])->middleware('jabatan:Pengawas_Lapangan');
Route::post('/Upload-LaporanProgress/{idproject}', [LaporanProgressStaffLapanganController::class, 'upload'])->middleware('jabatan:Pengawas_Lapangan');

// Laporan RAB
Route::get('/stafflapangan/Laporan-RAB/{idproject}', [ProjectControllerStafflapangan::class, 'laporanRAB'])->middleware('jabatan:Pengawas_Lapangan');
Route::post('/Upload-LaporanRAB/{idproject}', [LaporanRABStaffLapanganController::class, 'upload'])->middleware('jabatan:Pengawas_Lapangan');

// Dokumen Tambahan
Route::get('/stafflapangan/Dokumen-Tambahan/{idproject}', [ProjectControllerStafflapangan::class, 'dokumenTambahan'])->middleware('jabatan:Pengawas_Lapangan');
Route::post('/Upload-DokumenTambahan/{idproject}', [DokumenStaffLapanganController::class, 'upload'])->middleware('jabatan:Pengawas_Lapangan');
