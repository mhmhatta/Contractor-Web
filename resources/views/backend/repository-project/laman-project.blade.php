    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="col py-3">
            <div class="card h-100">
              <img class="card-img" src="https://source.unsplash.com/1800x900?building,%20night" alt="Card image cap" style="height: 250px;" />
          ...
          <div class="row mb-4">
              ...
              <div class="col-md-6 col-lg-6 mb-3 "> 
                <a href="/project/desc/{{ $project->id_project }}"><div class="card h-100">
                  ...
                  <img class="card-img" src="https://source.unsplash.com/900x600?pattern, black&1" alt="Card image cap" style="height: 200px;" />
              ...
              <div class="col-md-6 col-lg-6 mb-3 ">
                <a href="/project/team/{{ $project->id_project }}"><div class="card h-100">
                  ...
                  <img class="card-img" src="https://source.unsplash.com/900x600?pattern, black&2" alt="Card image cap" style="height: 200px;" />
                    <div class="card-img-overlay" style="padding: 8%;">
              ...
              <div class="col-md-6 col-lg-6 mb-3 ">
                <a href="/project/laporan/{{ $project->id_project }}"><div class="card h-100">
                  ...
                  <img class="card-img" src="https://source.unsplash.com/900x600?pattern, black&3" alt="Card image cap" style="height: 200px;" />
                    <div class="card-img-overlay" style="padding: 8%;">
